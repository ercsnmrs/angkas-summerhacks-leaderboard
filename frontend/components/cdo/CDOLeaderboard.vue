    ...
    <div class="container mb-10">
      <div>
        <div class="mx-auto max-w-xl text-center my-2 lg:mx-0 lg:flex-auto lg:text-left">
          <h1 class="text-3xl font-bold dark:text-white tracking-tight sm:text-4xl text-justify">Cagayan De Oro</h1>
          <p class="text-2xl font-semibold text-blue-700 dark:text-violet-200 font-medium tracking-tight sm:text-2xl text-justify">
            Checkout the leaderboard in CDO Service Zone
          </p>
        </div>
...
export default {
  ...
  methods: {
    fetchLeaderboard() {
      this.$axios.get('http://localhost:8000/leaderboard/CDO')
        .then((response) => {
